...
Table~\ref{tbl:s6_lcs} shows the clusters with the largest claimed 
numbers of sources. The top 4 are all moving groups or stellar
associations from
\citet{dias_proper_2014}: Platais~5, Platais~6, Mamajek~, and Collinder~70.
These membership claims should be regarded with serious
