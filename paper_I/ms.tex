...
development for the HATPI project (\url{hatpi.org}).  The
code is available
...
light curve for each star.  To remove outliers,
...
FITS files, which can be merged against the original source
catalog to obtain the membership probabilities reported by the
original authors.  Alternatively, simply restricting the targets of interest to
