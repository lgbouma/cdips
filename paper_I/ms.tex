...
analysis (PCA, see {\it e.g.}, \citealt{ivezic_statistics_2014} for a review).
...
knowledge of the light curve's shape.  Initially, this prior is simply that stars
...
relatively large number of time-series data points.  
We excluded templates within 20 pixels of any given target star.
We then performed
