...
An example of a full vetting report is described in
Appendix~\ref{appendix:vetreport}.

\subsection{Objects of Interest}
The objects that all vetters identified as planet candidates were then
fit with the usual \citet{mandel_analytic_2002} model. (CITE BATMAN).
The resulting fits are shown in Figure XXX.
The parameters of the planet candidates are given in Table YYY, and
are also available as cTOIs NNN.01 - MMM.01 on exofop-TESS (LINK).
...
%tODO: add plots and descriptions of other nice objects too
