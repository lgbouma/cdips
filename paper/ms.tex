...
\begin{figure*}[!ht]
    \gridline{
      ...
      \fig{cam1_cluster_field_star_positions.png}{0.49\textwidth}{}
    }
    %\begin{center}
    %    \leavevmode
...
\begin{figure}[t]
  ...
  The minimum RMS across all three
  aperture sizes was selected.  The photon and read noise are
  calculated using the effective area from \citet{vanderspek_2018}.
  The noise from unresolved background stars is a function of
  galactic latitude, and dominates over zodiacal light and read noise
  for faint stars near the galactic plane; the dotted line assumes a
  sight-line towards the center of Sector 6, Camera 1 (further details
  are in \S~\ref{subsec:lcstatistics}).
