...
the study of exoplanets is to search for planets in coeval groups of
stars, {\it i.e.} in clusters.  This includes the open clusters of
yore, as well as the moving groups and stellar associations that began
to be uncovered in the late 1990s \citep{zuckerman_young_2004}.  The
ages of these stellar ensembles are inferred through isochrone
analyses on color-magnitude diagrams, using an appropriate combination
main-sequence turnoff locations, pre-MS turnon locations, and/or MS
isochrones for the known cluster members \citep[{\it e.g.},][Section
3.4.3]{kharchenko_global_2012}.  Once calibrated, gyrochronology can
also be used to verify the age of a stellar ensemble \citep[{\it
e.g.},][]{barnes_color-period_2015,meibom_spin-down_2015,curtis_tess_2019}.
The ages of planets discovered in these cluster stars are then
assumed to equal the age of the larger stellar ensemble.
...
%FIXME probably rework the following two paragraphs?
...
survey in history.  As an order of magnitude estimate, the 
\citet{Kharchenko_et_al_2013} combined with the TESS apparent magnitude
calculator of \citet{Jaffe_Barclay_2017} indicated that $\approx
...
The actual number will be larger, as cluster membership catalogs
are not yet complete, even at these relatively bright magnitudes
\citep[{\it e.g.},][]{cantat-gaudin_gaia_2018,cantat-gaudin_newOCs_2019}.
...
For moving groups and stellar assocations, it is typically a simple thing to do
aperture photometry.  A number of promising targets from TESS are in various
stages of follow-up for this, notably DS Tuc Ab (TOI 200,
\citealt{benatti_dstuc_2019}, Newton+2019), as well as TOI-450 and TOI-451.
This is good, and these will remain benchmark systems because they are close
and bright.  However, to do statistics, we need more stars -- we need to
investigate the full range of cluster properties (densities, ages,
metallicities).  This motivates the need to go crowded.
