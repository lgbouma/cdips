...
\begin{figure*}[!t]
	...
	\vspace{-0.5cm}
	\caption{
		{\bf Positions of light curves from Sectors 6
			and 7 in galactic coordinates.}
		    Black: $G_{\rm Rp}<13$ field stars.  Blue: $G_{\rm Rp}<16$ target stars.
...
\begin{figure*}[t]
    ...
    For display purpses, a window of $\pm 4$ transit durations from the
    mid-point is displayed.
