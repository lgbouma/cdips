...
We reduced the TESS images to light curves using an image subtraction
approach.  The overall method is in the spirit of the reduction
...
(\url{hatpi.org}).  This code is available
...
\subsection{Meta-Data Collection \& WCS verification}
...
sequential stages (previously discussed by {\it e.g.}
\citealt{bakos_2010,huang_high-precision_2015,zhang_precision_2016}).
Given the heritage of our pipeline, we briefly note which of these concepts
were used in this reduction.
...
pointing \citep{vanderburg_hr858_2019}.
...
%TODO TODO TODO FIXME LEFT OFF EDITS HERE
%FIXME TURGID PROSE
