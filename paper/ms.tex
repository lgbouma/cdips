...
in the comments that this was done.  The uncertainties in e.g., the
planetary radii and impact parameters were found using linear error
propagation theory, under the idealized assumption that the covariance
between all stellar and planetary parameters was zero.

Finally, the determine the names of the objects -- that is whether
they were already TOIs, or cTOIs -- we cross-referenced based on a
combination of the TIC identifier, spatial position, and the ephemeris
of each object.
