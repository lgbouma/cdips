...
\begin{figure}[t]
    ...
    \gridline{\fig{target_star_cumulative_counts.png}{0.45\textwidth}{}}
    \vspace{-0.8cm}
    \gridline{\fig{target_star_hist_logt.png}{0.45\textwidth}{}}
	\end{center}
	\vspace{-0.8cm}
	\caption{
...
moving groups not identified in \citet{Kharchenko_et_al_2013}, we used
...
\begin{figure*}[t]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.9\textwidth]{tlsresult_sector6.png}%{ctoi_quilt.png}
	\end{center}
	\vspace{-0.2cm}
	\caption{
