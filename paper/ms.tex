...
\begin{figure}[!t]
	\begin{center}
		...
		\gridline{\fig{target_star_cumulative_counts.png}{0.41\textwidth}{}}
		\vspace{-0.8cm}
		\gridline{\fig{target_star_hist_logt.png}{0.41\textwidth}{}}
		\vspace{-0.8cm}
		\gridline{\fig{target_star_reference_pie_chart.png}{0.41\textwidth}{}}
	\end{center}
	\vspace{-0.8cm}
	\caption{
...
photometry and radial velocities to then verify the claimed membership
properties.  From their Table~2, we collect an initial 401{,}448
...
is the Gaia-DR2 \texttt{source\_id}.  The TIC identifiers are found
through a spatial cross-match after the light curves have been made,
subject to the requirement that the Gaia-DR2 source identifiers match
\citep{stassun_TIC_2018,stassun_TIC8_2019}.  We take this approach
